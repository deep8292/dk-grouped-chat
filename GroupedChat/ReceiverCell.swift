...
class ReceiverCell: UITableViewCell {
    ...
    func setCenterStyle() {
        self.messageBackground.layer.maskedCorners = [.layerMaxXMaxYCorner, .layerMaxXMinYCorner]
    }
    
    func setLastMessageStyle() {
        self.messageBackground.layer.maskedCorners = [ .layerMaxXMaxYCorner, .layerMaxXMinYCorner, .layerMinXMaxYCorner]
    }
    
    func setFirstMessageStyle() {
        self.messageBackground.layer.maskedCorners = [.layerMaxXMaxYCorner, .layerMaxXMinYCorner, .layerMinXMinYCorner]
    }
